  ...
  return (
    <div className='login'>
        ...
        <form onSubmit={onSubmitHandler} className="login-form">
            ...
            <input onChange={(e) => setEmail(e.target.value)} value={email} placeholder='Email address' type="email" className="form-input" required/>
            <input onChange={(e) => setPassword(e.target.value)} value={password} placeholder='password' type="password" className="form-input" required/>
            <button type='sumbit'>{currState === "Sign up" ? "Create account" : "Login now"}</button>
